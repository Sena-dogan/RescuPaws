...
$BottomNavBarUiModelCopyWith<BottomNavBarUiModel> get copyWith => _$BottomNavBarUiModelCopyWithImpl<BottomNavBarUiModel>(this as BottomNavBarUiModel, _$identity);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BottomNavBarUiModel&&(identical(other.navIndex, navIndex) || other.navIndex == navIndex));
}
...
abstract mixin class $BottomNavBarUiModelCopyWith<$Res>  {
  factory $BottomNavBarUiModelCopyWith(BottomNavBarUiModel value, $Res Function(BottomNavBarUiModel) _then) = _$BottomNavBarUiModelCopyWithImpl;
@useResult
$Res call({
 int navIndex
});
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _BottomNavBarUiModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _BottomNavBarUiModel value)  $default,){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _BottomNavBarUiModel value)?  $default,){
final _that = this;
switch (_that) {
case _BottomNavBarUiModel() when $default != null:
return $default(_that);case _:
...
class _BottomNavBarUiModel implements BottomNavBarUiModel {
  ...
  factory _BottomNavBarUiModel.fromJson(Map<String, dynamic> json) => _$BottomNavBarUiModelFromJson(json);

@override@JsonKey() final  int navIndex;

/// Create a copy of BottomNavBarUiModel
/// with the given fields replaced by the non-null parameter values.
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$BottomNavBarUiModelCopyWith<_BottomNavBarUiModel> get copyWith => __$BottomNavBarUiModelCopyWithImpl<_BottomNavBarUiModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$BottomNavBarUiModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _BottomNavBarUiModel&&(identical(other.navIndex, navIndex) || other.navIndex == navIndex));
}
...
/// @nodoc
abstract mixin class _$BottomNavBarUiModelCopyWith<$Res> implements $BottomNavBarUiModelCopyWith<$Res> {
  factory _$BottomNavBarUiModelCopyWith(_BottomNavBarUiModel value, $Res Function(_BottomNavBarUiModel) _then) = __$BottomNavBarUiModelCopyWithImpl;
@override @useResult
$Res call({
 int navIndex
});
